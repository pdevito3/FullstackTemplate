...
namespace FullstackTemplate.Server.Databases.Migrations
{
    ...
    [Migration("20251228054811_AddUserRolesAndPermissions")]
            ...
            modelBuilder.Entity("FullstackTemplate.Server.Domain.Users.User", b =>
                {
                    ...
                    b.OwnsOne("FullstackTemplate.Server.Domain.Users.UserRole", "Role", b1 =>
                        {
                            b1.Property<Guid>("UserId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("FullstackTemplate.Server.Domain.Users.UserPermission", b =>
                {
                    ...
                    b.OwnsOne("FullstackTemplate.Server.Domain.Users.Permission", "Permission", b1 =>
                        {
                            ...
                            b1.WithOwner()
                                ...
                                .HasConstraintName("fk_user_permissions_user_permissions_id");
                        });
